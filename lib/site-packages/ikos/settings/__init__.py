...
THIS_PYC = 'ikos/settings/__init__.pyc'
THIS_PY = 'ikos/settings/__init__.py'
THIS_INSTALL_PYC = 'lib/site-packages/ikos/settings/__init__.pyc'
THIS_INSTALL_PY = 'lib/site-packages/ikos/settings/__init__.py'


PREFIX = (os.path.abspath(__file__))
PREFIX = PREFIX.replace('\\', '/')
PREFIX = PREFIX.replace(THIS_PYC, '')
PREFIX = PREFIX.replace(THIS_PY, '')

SRC_ROOT = 'E:/wangbx/IKOS/ikos/analyzer'

# BIN_DIR = os.path.join(PREFIX, 'bin')
BIN_DIR = (os.path.abspath(__file__))
BIN_DIR = BIN_DIR.replace('\\', '/')
BIN_DIR = BIN_DIR.replace(THIS_INSTALL_PYC, 'bin')
BIN_DIR = BIN_DIR.replace(THIS_INSTALL_PY, 'bin')
BIN_DIR = BIN_DIR.replace(THIS_PYC, '')
BIN_DIR = BIN_DIR.replace(THIS_PY, '')

INCLUDE_DIR = os.path.join(PREFIX, 'include')

LIB_DIR = os.path.join(PREFIX, 'lib')

LLVM_CONFIG = 'E:/wangbx/IKOS/ikos-dep/bin/llvm-config.exe'

LLVM_VERSION = '8.0.0'

LLVM_PREFIX = 'E:/wangbx/IKOS/ikos-dep'

LLVM_BIN_DIR = 'E:/wangbx/IKOS/ikos-dep/bin'

LLVM_INCLUDE_DIR = 'E:/wangbx/IKOS/ikos-dep/include'

LLVM_LIB_DIR = 'E:/wangbx/IKOS/ikos-dep/lib'

CLANG = 'clang-7.0.exe'
#''
CLANGXX = 'clang-7.0.exe'
...
def clang():
    path = os.path.join(BIN_DIR, CLANG)
    return path
...
def opt():
    path = os.path.join(BIN_DIR, 'opt.exe')
    return path


def llvm_link():
    path = os.path.join(LLVM_BIN_DIR, 'llvm-link.exe')
    assert os.path.isabs(path)
...
def llvm_objdump():
    path = os.path.join(LLVM_BIN_DIR, 'llvm-objdump.exe')
    assert os.path.isabs(path)
...
def llvm_objcopy():
    path = os.path.join(LLVM_BIN_DIR, 'llvm-objcopy.exe')
    assert os.path.isabs(path)
...
def ikos_pp():
    path = os.path.join(BIN_DIR, 'ikos-pp.exe')
    return path


def ikos_analyzer():
    path = os.path.join(BIN_DIR, 'ikos-analyzer.exe')
    return path
...
def ikos():
    ...
    return path
#def ikos_get_entry():
#    path = os.path.join(BIN_DIR, 'ikos-get-entry.exe')
#    return path
