...
class Formatter(object):
    ...
    def format(self, report, show_call_context):
...
class TextFormatter(Formatter):
    ...
    def format(self, report, show_call_context):
        ...
        for statement_report in statement_reports:
            ...
            if self.verbosity >= 3 or show_call_context:
...
class AutoFormatter(TextFormatter):
    ...
    def format(self, report, show_call_context):
        if len(report.statement_reports) == 0:
            ...
            super(AutoFormatter, self).format(report, show_call_context)
